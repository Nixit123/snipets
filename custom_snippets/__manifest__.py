{
    ...
    'data': [
        ...
        'views/snippets/alert.xml',
        'views/snippets/accordion.xml',
        'views/snippets/badge.xml',
        'views/snippets/breadcrumb.xml',
        'views/snippets/buttons.xml',
        'views/snippets/popover.xml',
        # 'views/snippets/toast.xml',
        # 'views/snippets/edit.xml',
        # 'views/options.xml',
        'demo/demo.xml',
    ],
